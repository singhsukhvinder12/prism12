...
import com.seasia.prism.core.ui.TrimmerActivity;
...
public class BaseCameraActivity extends AppCompatActivity {
    ...
    private com.seasia.prism.newsfeed.camera.SampleGLView sampleGLView;
        ...
        findViewById(R.id.btn_filter).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (filterDialog == null) {
                    ...
                    final Filters[] filters = com.seasia.prism.newsfeed.camera.Filters.values();
...
//        }
    ...
    private void changeFilter(com.seasia.prism.newsfeed.camera.Filters filters) {
