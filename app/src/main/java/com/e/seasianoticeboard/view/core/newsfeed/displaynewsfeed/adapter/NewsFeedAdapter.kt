...
//                }
                ...
                if (item.get(index).PostedById.equals(context.sharedPref!!.getString(PreferenceKeys.USER_ID, "").toString())) {
                    ...
                    context.sharedPref!!.saveString(PreferenceKeys.USER_IMAGE,item.get(index).PostedByImageUrl!!)
                    context.sharedPref!!.saveString(PreferenceKeys.USERNAME,item.get(index).PostedBy!!)
                } else {
