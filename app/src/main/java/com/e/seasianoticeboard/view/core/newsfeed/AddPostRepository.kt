...
class AddPostRepository {
    var data: MutableLiveData<AddPostResponse>? = null
    ...
    fun getPostData(addPost: AddPostInput, videoFIle: File?, audioFIle: File?, imagesList: ArrayList<AddUpdateImageInput>?): MutableLiveData<AddPostResponse> {
