...
//        private String filePath = Environment.getExternalStorageDirectory() + "/recorded_audio.wav";
    private String filePath = getVideoFilePath();
    ...
    private AndroidAudioRecorder(AppCompatActivity activity) {
    ...
    public static AndroidAudioRecorder with(AppCompatActivity activity) {
...
//        }
//
//        String outPath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath() + File.separator + "VID_" + new SimpleDateFormat("yyyyMMdd_HHmmss", getLocale()).format(new Date()) + ".mp4";
//
//        return outPath;
//    }
